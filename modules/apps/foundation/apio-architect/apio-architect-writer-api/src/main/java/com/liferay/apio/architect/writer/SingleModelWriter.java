...
public class SingleModelWriter<T> {
	...
	public Optional<String> write() {
		...
		_writeNestedLists(_representorFunction::apply, _singleModel, null);
	...
	private <U> void _writeItem(
		JSONObjectBuilder pageJSONObjectBuilder, SingleModel<U> singleModel,
		FunctionalList<String> embeddedPathElements,
		BaseRepresentorFunction baseRepresentorFunction) {
		...
		_singleModelMessageMapper.onStartItem(
			_jsonObjectBuilder, pageJSONObjectBuilder, itemJsonObjectBuilder,
			singleModel);
		...
		_writePageNestedResources(
			baseRepresentorFunction, singleModel, pageJSONObjectBuilder,
			itemJsonObjectBuilder, null);

		_singleModelMessageMapper.onFinishNestedCollectionItem(
			pageJSONObjectBuilder, itemJsonObjectBuilder, singleModel);
	}
	...
	private <S> void _writeItemEmbeddedModelFields(
		...
		fieldsWriter.writeRelatedModels(
			...
			(embeddedSingleModel, embeddedModelEmbeddedPathElements) ->
				_writeItemEmbeddedModelFields(
					embeddedSingleModel, embeddedModelEmbeddedPathElements,
					collectionJsonObjectBuilder, itemJsonObjectBuilder,
					baseRepresentorFunction),
			(resourceURL, resourceEmbeddedPathElements) ->
				_singleModelMessageMapper.mapLinkedResourceURL(
		...
		_writePageNestedResources(
			baseRepresentorFunction, singleModel, collectionJsonObjectBuilder,
			itemJsonObjectBuilder, embeddedPathElements);
	}

	private <U> void _writeNestedList(
		String fieldName, List<U> list,
		FunctionalList<String> embeddedPathElements,
		BaseRepresentorFunction baseRepresentorFunction) {
	...
	private <S> void _writeNestedLists(
		...
		baseRepresentorFunction.apply(
			...
			nestedListFieldFunction -> {
				...
				_writeNestedList(
					nestedListFieldFunction.key, list,
	...
	private <U> void _writePageNestedResources(
		...
		baseRepresentorFunction.apply(
			...
			nestedFieldFunction -> {
				...
				_writeItemEmbeddedModelFields(
					new SingleModel<>(mappedModel, "", Collections.emptyList()),
					embeddedNestedPathElements, collectionJsonObjectBuilder,
